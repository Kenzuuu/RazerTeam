...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nor manually add [assistant](@JessicaXMusic) to your Group and try again</b>",
                    )
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/b9c82a001237417a80342.jpg"
