# Copyright (C) 2021 Isabella

# This file is part of Isabella (Telegram Bot)
...
from Isabella import BOT_ID
from Isabella.db.mongo_helpers.aichat import add_chat, get_session, remove_chat
from Isabella.function.inlinehelper import arq
from Isabella.function.pluginhelpers import admins_only, edit_or_reply
from Isabella.services.pyrogram import pbot as Isabella
...
daisy_chats = []
en_chats = []
# AI Chat (C) 2020-2021 by @Thilina2004 
    ...
    if chat_id in en_chats:
        ...
        if not "en" in lan and not lan == "":
            try:
                ...
                return
        try:
            await Isabella.send_chat_action(message.chat.id, "typing")
            await message.reply_text(pro)
        except CFError:
            return
...
@daisyx.on_message(
    filters.regex("Isabella|Isabella|Isabella|Isabella")
    & ~filters.bot
    & ~filters.via_bot
    & ~filters.forwarded
    & ~filters.reply
